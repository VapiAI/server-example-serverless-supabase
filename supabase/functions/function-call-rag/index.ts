...
import { getCharacterInspiration } from "../_shared/function-call/getCharacterInspiration.ts";
...
/* To invoke locally:
  ...
  curl -i --location --request POST 'http://127.0.0.1:54321/functions/v1/function-call-rag' \
